...
console.log(zunBox)
    zunBox.addEventListener('keydown', function(e){
    	if (e.key === "Enter") {  
        	...
        	let originalAnswer = "%N is the number of neutrons of an atom E if M is the mass number of the atom E,and P is the number of the protons of atom E,and N = M-P";
...
console.log(yunBox)
    yunBox.addEventListener('keydown', function(e){
    	if (e.key === "Enter") {  
        	...
        	let originalAnswer = "%M is the mass number of an atom E if N is the number of neutrons of atom E,and P is the number of the protons of atom E,and M = N+P";
        	if(answer.toLowerCase() == originalAnswer.toLowerCase()){
...
factBox.addEventListener('keydown', function(e){
	if (e.key === "Enter") { 
    	...
    	let originalAnswer = "massNumber(E, M) :- neutronsOf(E, N), protonsOf(E, P),M = N+P.";
    	if(answer.toLowerCase() == originalAnswer.toLowerCase()){
